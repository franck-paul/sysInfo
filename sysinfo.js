...
$(function() {
  ...
  var getStaticCacheFilename = function(url, fn) {
    dotclearAjax('getStaticCacheName', {
      url: url
    }, fn, '');
  };

  var loadStaticCacheDirs = function(dir, fn) {
    dotclearAjax('getStaticCacheDir', {
      root: dir
    }, fn, '');
  };

  var loadStaticCacheList = function(dir, fn) {
    dotclearAjax('getStaticCacheList', {
      root: dir
    }, fn, '');
  };
  ...
  var loadServerFile = function(filename, type, fn) {
    switch (type) {
      case 'tpl':
        dotclearAjax('getCompiledTemplate', {
          file: filename
        }, fn, dotclear.msg.tpl_not_found);
        break;
      case 'sc':
        dotclearAjax('getStaticCacheFile', {
          file: filename
        }, fn, dotclear.msg.sc_not_found);
        break;
    }
  };
